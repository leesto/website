...
class ContactAccidentRequest extends Request
{
	...
	public function messages()
	{
		return [
			...
			'contact_name.required'         => 'Please provide the name of the injured party',
			'contact_email.required'        => 'Please provide an email address for the injured party',
			'contact_email.email'           => 'Please provide a valid email address',
			'contact_phone.required'        => 'Please provide a phone number for the injured party',
